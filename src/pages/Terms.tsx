...
export default function TermsAndConditions() {
    ...
    return (
        ...
        <div className="w-full text-gray-900 py-14 px-5 md:px-10 font-serif">
                ...
                <div className="space-y-8 leading-relaxed">
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-6 space-y-2 mt-3">
                            ...
                            <li>
                                ...
                                or "Our" in this Agreement) refers to MS Tile Agencies, Ramanattukara,
                                near Chemillil Masjid, Kozhikode, Kerala, 673633.
                            </li>
                            <li>
                            ...
                            <li>
                                <strong>Website</strong> refers to www.mstile.in, accessible from
                                <span className="text-blue-600"> http://www.mstile.in</span>
                            </li>
                            <li>
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            all warranties, whether express, implied, statutory or otherwise, with respect to
                            the Service, including all implied warranties of merchantability, fitness for a
                            particular purpose, title and non-infringement, and warranties that may arise out
                        ...
                        <p className="mt-3">
                            ...
                            currency of any information or content provided through the Service; or (iv) that
                    ...
                    <section>
                        ...
                        <h3 className="text-xl font-semibold mt-5 mb-3">Waiver</h3>
                        <p>
                    ...
                    <section>
                        ...
                        <p className="mt-3">
                            ...
                            effective, You agree to be bound by the revised terms. If You do not agree to the
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-6 mt-3">
                            <li>By email: <span className="text-blue-600">infomstiles@gmail.com</span></li>
                        </ul>
                    </section>
